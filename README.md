...
Using Keyring can be better alternative compared to typing password or using enviorment variable. The service / key name would be aws-azure-login and account would be the signin email address.
